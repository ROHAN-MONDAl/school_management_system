...
$query_classes = "SELECT DISTINCT branch FROM teachers";
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-12">
                                            <div class="table-responsive">
                                                ...
                                                <form action="teachers_mark_atendance.php" method="GET">
                                                    <div class="form-group">
                                                        <label for="class">Select teachers attendance:</label>
                                                    ...
                                                    <div class="form-group text-center float-end col-12 col-lg-6 d-flex flex-column flex-lg-row justify-content-center">
                                                        ...
                                                        <a href="teachers_att_history.php" class="mb-2 mb-lg-0 col-12 col-lg-6">
