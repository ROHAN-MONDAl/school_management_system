...
// Query to fetch the profile picture path securely (without using prepared statements here)
$sql = "SELECT profile_picture FROM user_settings WHERE username = '$username'"; // Simple query without prepared statements
